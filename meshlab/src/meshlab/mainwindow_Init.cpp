...
void MainWindow::createActions()
{
  ...
  resetLightingAct = new QAction(tr("&Reset Lighting"), this);
  resetLightingAct->setShortcutContext(Qt::ApplicationShortcut);
  resetLightingAct->setShortcut(Qt::CTRL+Qt::SHIFT+Qt::Key_R);
  connect(resetLightingAct, SIGNAL(triggered()), this, SLOT(resetLighting()));

  saveLightingAct = new QAction(tr("&Save Lighting"), this);
  saveLightingAct->setShortcutContext(Qt::ApplicationShortcut);
  saveLightingAct->setShortcut(Qt::CTRL+Qt::SHIFT+Qt::Key_S);
  connect(saveLightingAct, SIGNAL(triggered()), this, SLOT(saveLighting()));

  loadLightingAct = new QAction(tr("&Load Lighting"), this);
  loadLightingAct->setShortcutContext(Qt::ApplicationShortcut);
  loadLightingAct->setShortcut(Qt::CTRL+Qt::SHIFT+Qt::Key_L);
  connect(loadLightingAct, SIGNAL(triggered()), this, SLOT(loadLighting()));
    ...
    showTrackBallAct->setCheckable(false);
...
void MainWindow::createToolBars()
{
    ...
    mainToolBar->addAction(saveLightingAct);
    mainToolBar->addAction(loadLightingAct);
    mainToolBar->addAction(resetLightingAct);
...
void MainWindow::createMenus()
{
    ...
    fileMenu->addAction(saveLightingAct);
    fileMenu->addAction(loadLightingAct);
    fileMenu->addAction(resetLightingAct);
